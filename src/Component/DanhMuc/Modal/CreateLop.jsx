                ...
                <div className="relative top-[15%] mx-auto p-4 flex flex-col border w-[60%] shadow-lg rounded-md bg-white">
                    ...
                    <div className="flex w-full">
                        <div className="w-[50%] text-sm ml-8">
                            ...
                            <input className="w-[90%] h-8 pl-2 border rounded-sm my-2 rounded-[3px]" ref={name} placeholder="Nhập tên lớp" />
                        </div>
                        <div className="w-[50%] text-sm ml-8">
                            <p className="font-medium">Khoá</p>
                            <input className="w-[90%] h-8 pl-2 border rounded-sm my-2 rounded-[3px]" ref={course_id} placeholder="Chọn khoá"/>
                        </div>
                    </div>
                    <br />
                    <hr className="" />
